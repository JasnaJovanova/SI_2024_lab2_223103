...
public class SILab2Test {
    ...
    public void testingBranches(){
        ...
        exception =  assertThrows(RuntimeException.class,()->siLab2.checkCart(items1,1));
        assertTrue(exception.getMessage().contains("No barcode!"));

        List<Item> items2 = new ArrayList<>();
        items2.add(new Item("item1","notValid",500,0));
        exception =  assertThrows(RuntimeException.class,()->siLab2.checkCart(items2,301));
